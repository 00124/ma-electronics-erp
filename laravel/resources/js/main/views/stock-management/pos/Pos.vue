    ...
    setup() {
        ...
        const recalculateValues = (product) => {
            ...
            if (product.product_type != "service") {
                quantityValue =
                    quantityValue > maxQuantity ? maxQuantity : quantityValue;
            }
        ...
        const viewQuote = () => {
            ...
            addEditRequestAdmin({
                ...
                success: (res) => {
                    printInvoiceOrder.value = res.order;
                    printInvoiceModalVisible.value = true;
                    resetPos();
                },
            });
