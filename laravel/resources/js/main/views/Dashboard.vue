        ...
        <a-row :gutter="[8, 8]" class="mt-30 mb-10">
            ...
            >
                <a-flex justify="flex-end" wrap="wrap" gap="small">
                    ...
                    <a-button
                        :type="
                            activeDateSelector == 'week' ? 'primary' : 'default'
                        "
                    ...
                    <a-button
                        :type="
                            activeDateSelector == 'year' ? 'primary' : 'default'
                        "
