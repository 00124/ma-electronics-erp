...
class Order extends BaseModel
{
    ...
    protected $hidden = ['id', 'warehouse_id', 'from_warehouse_id', 'user_id', 'tax_id', 'staff_user_id', 'cancelled_by', 'parent_order_id'];

    protected $appends = ['xid', 'x_warehouse_id', 'x_from_warehouse_id', 'x_user_id', 'x_tax_id', 'x_staff_user_id', 'x_cancelled_by', 'x_parent_order_id', 'document_url'];
    ...
    protected $hashableGetterFunctions = [
        ...
        'getXParentOrderIdAttribute' => 'parent_order_id',
    ];
